...
function updateProjectFromNetlifySiteOrDeploy(netlifySiteOrDeploy, project) {
    ...
    const deployCustomDomain = netlifySiteOrDeploy.custom_domain;
    ...
    if (customDomainChanged) {
        project.customDomain = netlifySiteOrDeploy.custom_domain;
    }

    if (defaultDomainChanged) {
        project.defaultDomain = netlifySiteOrDeploy.default_domain;
    }
