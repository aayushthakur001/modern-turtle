...
import {
    ...
    ProjectGroupRole,
    RegisteredThemeRole
} from './organization-models-access-control';
import { RoleAssignmentPlugin, RestrictedModel } from './plugins/role-assignment/role-assignment';
...
} from './organization.membershipInvite.submodel';
import {
    IRegisteredTheme,
    IRegisteredThemeDoc,
...
export interface IOrganizationModel
    extends Model<IOrganizationDoc>,
        ...
        RestrictedModel<OrganizationRole>,
...
OrganizationSchema.set('toJSON', {
    ...
    transform: function (
        ...
        ret: IOrganizationJSON &
            Pick<IOrganizationDoc, '_id'> &
            Pick<SoftDeleteInterface, 'deleted'> &
            Pick<RestrictedModel<OrganizationRole>, 'accessControlList'>
    ) {
        delete ret._id;
    }
});
