...
import { RestrictedNestedModel } from './plugins/role-assignment/role-assignment-nested';
...
export interface IRegisteredThemeDoc extends IRegisteredTheme, Document<Types.ObjectId>, RestrictedNestedModel {
    id?: string;
}
