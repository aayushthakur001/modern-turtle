...
export async function createOrganization(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        logger.error('Organization: [createOrganization]', { message: e.message });
        res.status(e.status || 500).json({ message: e.message });
        next(e);
    }
}
...
export async function deleteOrganization(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        logger.error('Organization: [deleteOrganization]', { message: e.message });
        res.status(e.status || 500).json({ message: e.message });
        next(e);
    }
}
...
export async function addUserToOrganization(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        logger.error('Organization: [addUserToOrganization]', { message: e.message });
        res.status(e.status || 500).json({ message: e.message });
        next(e);
    }
}
...
export async function removeInvite(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        const organization = await Organization.removeMembershipInvite(organizationObjectId, user, inviteId);
...
export async function addInvite(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        const { organization, token: inviteToken } = await Organization.addMembershipInvite(organizationObjectId, user, email, role);
...
export async function acceptInvite(req: Request, res: Response, next: NextFunction): Promise<void> {
    try {
        ...
        const organization = await Organization.acceptMembershipInvite(organizationObjectId, user, token);
        res.status(200).json(organization);
    } catch (e: any) {
