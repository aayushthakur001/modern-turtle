...
router.get(
    '/github-app',
    genericAuthRoutes.baseAuthHandler.bind(null, 'github-app'),
    genericAuthRoutes.genericAuth.bind(null, 'github-app')
);
...
router.get(
    '/contentful',
    genericAuthRoutes.baseAuthHandler.bind(null, 'contentful'),
    genericAuthRoutes.genericAuth.bind(null, 'contentful')
);
...
router.get(
    '/digitalocean',
    genericAuthRoutes.baseAuthHandler.bind(null, 'digitalocean'),
    genericAuthRoutes.genericAuth.bind(null, 'digitalocean')
);
router.get(
    '/digitalocean/callback',
    passport.authenticate('digitalocean'),
    genericAuthRoutes.genericAuthCallback.bind(null, 'digitalocean')
);
